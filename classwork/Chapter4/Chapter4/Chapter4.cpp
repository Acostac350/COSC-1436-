...
int main()
{
    ...
    bool isEmpty = title == "";
    if (isEmpty)
        std::cout << "A title is required " << std::endl;
   ...
   /* if (releaseYear < 1900)
    ...
    std::cout << "Enter the optional user rating (1.0 to 10.0): ";
    std::cin >> userRating;
    ...
    {
        std::cout << "Rating must be between 1.0 10.0" << std::endl;
        userRating = 1.0;
    }*/
...
void relationaldemo()
{
    ...
    // areEqual = 10 == left , INCORRECt. areEqual = left == 10; CORRECT
    // areEqual = 10 = left; 
    ...
    // Comparison works but it is case sensitive
    std::string name1 = "Bob ";
    std::string name2 = "bob ";
    std::cout << (name1 == name2) << std::endl;

    // To compare strings case insensitive use the strcmp1
    // > 0 ::= left > right
    // < 0 ::= left < right
    // ==0 ::= left == right
